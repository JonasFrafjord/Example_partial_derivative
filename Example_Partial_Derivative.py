...
# Take the partial derivative of the function with respect to x1, and input the values in the list [A,B,C]. Since Python is 0-indexed (lists/arrays start at 0), the x1 is the 0th variable in the function. The first delx1_value gives the partial derivative in one point. The second, delx1_list, gives the partial derivative as an array of 100 elements where x1 varies from -2 to 2.
